...
async function extractHtmlImgDataUris() {
    ...
    for (const file of htmlFiles) {
        ...
        content = content.replaceAll(IMG_TAG_REGEX, (fullMatch, preAttrs, quote, srcContent, postAttrs) => {
            ...
            try {
                ...
                console.warn(`Failed to process Image Data URI in ${file}: ${err.message}`);
    ...
    console.log(`HTML Image Extraction complete. Extracted ${totalExtracted} unique assets.`);
}

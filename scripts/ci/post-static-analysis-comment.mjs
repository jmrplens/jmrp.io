...
const LOGOS = {
    ...
    lychee: 'https://img.shields.io/badge/Lychee-232323?style=flat&logo=linktree&logoColor=white', // Using generic link icon/shield
    typos: 'https://img.shields.io/badge/Typos-grey?style=flat&logo=microsoftexcel&logoColor=white', // Placeholder or generic text icon
    security: 'https://img.shields.io/badge/NPM_Audit-CB3837?style=flat&logo=npm&logoColor=white',
};
...
function generateComment(results) {
    ...
    // Check if all passed
    const allPassed = tools.every(t => t.outcome === 'success' || t.outcome === 'skipped'); // skipped counts as pass contextually or ignored
    ...
    for (const tool of tools) {
        ...
        const outcomeText = tool.outcome ? tool.outcome.charAt(0).toUpperCase() + tool.outcome.slice(1) : 'Unknown';

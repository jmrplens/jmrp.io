...
export default function ServiceStats({ type, children }: Props) {
            ...
            <div class="stats-wrapper-col">
                ...
                <div class="status-header">
                    ...
                    <div class="status-text-muted">
                        <strong class="status-text">{peersCount?.toLocaleString() || "?"}</strong> Known Instances
                    </div>
                </div>
    ...
    if (type === 'meshmonitor-lf') {
        return (
            <div class="stat-item">
                <span>LongFast Nodes:</span> <strong>{stats.data?.activeNodes || "?"}</strong>
            </div>
        );
    }
    ...
    if (type === 'meshmonitor-mf') {
        return (
            <div class="stat-item">
                <span>MedFast Nodes:</span> <strong>{stats.data?.activeNodes || "?"}</strong>
            </div>
        );
    }
        ...
        return (
            <div class="stats-wrapper-small-gap">
                    ...
                    <div class="meshtastic-left">
                        ...
                        <div>
                            ...
                            <div class="meshtastic-sub">
                                {potatoNodes} Nodes
                                {potatoVersion && <span class="meshtastic-ver">• {potatoVersion}</span>}
                            </div>
                        </div>
                    </div>
                    <a href="https://potatomesh.jmrp.io" target="_blank" class="btn btn-outline btn-xs" aria-label="View PotatoMesh Map">
                        View Map
                    </a>
                </div>
                ...
                <div class="meshtastic-row">
                    ...
                    <a href="https://mesh_lf.jmrp.io/meshmonitor" target="_blank" class="btn btn-outline btn-xs" aria-label="View MeshMonitor LF">
                        View Monitor
                    </a>
                </div>
                ...
                <div class="meshtastic-row">
                    ...
                    <a href="https://mesh_mf.jmrp.io/meshmonitor" target="_blank" class="btn btn-outline btn-xs" aria-label="View MeshMonitor MF">
                        View Monitor
                    </a>
                </div>
            </div>

...
There is no advertising, no affiliate link, no sponsored content and no mailing list here. The only way to support the work is a GitHub Sponsors link on the projects page — an ordinary outbound link that sets nothing and measures nothing, and that is not on any other page. Beyond that the site is not monetized, so there is no incentive to collect anything about you.

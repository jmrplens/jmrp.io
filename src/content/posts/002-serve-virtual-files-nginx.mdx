...
draft: false
heroImage: "/src/assets/images/posts/features-guide-hero.png"
...
<Callout type="warning">
  The content in a `return` directive must be a single, unbroken string. Newlines (`\n`) are permitted within the string to format the output.
</Callout>
...
To create seamless links between your website and your mobile app ([Android App Links](https://developer.android.com/develop/ui/views/launch/verify-domain-associations) and [iOS Universal Links](https://developer.apple.com/documentation/xcode/supporting-associated-domains)), you need to host specific JSON files.

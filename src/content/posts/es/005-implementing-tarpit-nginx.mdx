...
howto:
  ...
  steps:
    - name: "Preparar el bloque http"
      ...
      anchor: "paso-1-preparar-nginx-bloque-http"
    - name: "Crear el snippet del tarpit"
      ...
      anchor: "paso-2-crear-el-snippet-del-tarpit"
    - name: "Definir las rutas sensibles"
      ...
      anchor: "paso-3-definir-las-rutas-sensibles-las-trampas"
    - name: "Configurar el server block"
      ...
      anchor: "paso-4-configurar-el-server-block"
    - name: "Probar la configuración"
      ...
      anchor: "paso-5-probar-la-configuración"
...
<Callout type="keypoint" title="Lo que este tarpit ha atrapado de verdad">

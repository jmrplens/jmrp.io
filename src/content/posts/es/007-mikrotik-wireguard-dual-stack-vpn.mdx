...
<TLDRSummary title="TL;DR — WireGuard dual-stack en RouterOS">
  ...
  - **Hay que fijar el MSS de TCP a 1420 o las descargas grandes se atascan.** El MSS es la MTU menos los 40 bytes de cabecera IPv6 menos los 20 de cabecera TCP, y 1420 es el valor conservador que aguanta en ambas pilas.

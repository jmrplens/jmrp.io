...
Dos cosas sobre esa cifra. La primera es que es una instantánea de esa ventana, no una propiedad estable del sitio. La misma consulta sobre los siete días completos del 26 de agosto al 1 de septiembre de 2026 da un **20,1 %** —10.508 de 52.341— y oscila de un día a otro: 22,3 %, 16,9 %, 22,8 %, 12,8 %, 24,0 %, 18,8 %, 25,1 %. La segunda es que ninguna de las dos lecturas se puede recalcular después. El plan Free retiene `httpRequestsAdaptiveGroups` ocho días y rechaza cualquier consulta más antigua con `cannot request data older than 1w1d`, así que ambas cifras son observaciones fechadas que la propia fuente no volverá a servir. Los datos por día están aquí por eso: son la única forma en que la segunda medición sigue siendo auditable.

...
<FileContent filename="/etc/nginx/nginx.conf" icon="devicon:nginx" collapsible ariaLabel="Configuración principal de Nginx">
```nginx
# Main context
...
<FileContent filename="/etc/nginx/sites-available/example.com.conf" icon="devicon:nginx" collapsible ariaLabel="Configuración específica del sitio Nginx">
```nginx
server {

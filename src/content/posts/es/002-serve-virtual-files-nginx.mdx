...
howto:
  ...
  steps:
    - name: "Entender la prioridad del location matching"
      ...
      anchor: "prioridad-del-location-matching"
    - name: "Elegir entre root, alias o try_files"
      ...
      anchor: "directivas-principales-root-alias-try_files"
    ...
    - name: "Añadir named locations y fallbacks internos"
      ...
      anchor: "named-locations-y-fallbacks"
    ...
    - name: "Usar njs para archivos virtuales dinámicos"
      ...
      anchor: "contenido-dinámico-con-nginx-javascript-njs"
    - name: "Añadir endpoints de salud y monitorización"
      ...
      anchor: "endpoints-de-salud-y-monitorización"
    - name: "Validar y recargar la configuración"
      ...
      anchor: "validar-la-configuración"
---

...
<Table title="Herramientas de prueba de CSP">
  ...
  <tbody>
    <tr>
      <td><a href="https://developer.mozilla.org/en-US/observatory" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="Mozilla Observatory (se abre en nueva pestaña)"><strong>Mozilla Observatory</strong></a></td>
      <td>Evaluación completa de cabeceras de seguridad (A+ posible)</td>
    </tr>
    <tr>
      <td><a href="https://csp-evaluator.withgoogle.com/" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="Google CSP Evaluator (se abre en nueva pestaña)"><strong>Google CSP Evaluator</strong></a></td>
      <td>Encuentra bypasses lógicos en tu política (muy recomendado)</td>
    </tr>
    <tr>
      <td><a href="https://securityheaders.com/" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="SecurityHeaders.com (se abre en nueva pestaña)"><strong>SecurityHeaders.com</strong></a></td>
      <td>Análisis rápido de cabeceras y puntuación</td>
    </tr>
    <tr>
      <td><a href="https://report-uri.com/tools/csp-hash-generator" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="CSP Hash Generator (se abre en nueva pestaña)"><strong>CSP Hash Generator</strong></a></td>

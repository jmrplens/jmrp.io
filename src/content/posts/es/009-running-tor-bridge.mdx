...
lead: "Un mismo puente ejecutando obfs4 y WebTunnel a la vez, con Nginx haciendo que la mitad WebTunnel sea indistinguible de HTTPS normal. Running y Valid llegan en una hora; Stable exige 7 días de uptime continuo y Guard unos 8."
...
- **Los flags del consenso tardan días, no minutos.** Running y Valid llegan en torno a una hora, pero Stable exige unos 7 días de uptime continuo y Guard unos 8: un puente que se reinicia cada dos días no los consigue nunca.
...
Tres nodos Tor, que es justo el motivo de que esta guía exista en lugar de ser
un resumen del manual.

El puente corre en un mini PC en casa, en Campello, sobre la misma línea de
fibra doméstica que todo lo demás de la [página del homelab](/es/homelab/), y
por detrás del router MikroTik: de ahí que la sección de NAT y reenvío de
puertos de más arriba esté escrita como está. Los dos relays son instancias VPS
de IONOS, una en Londres y otra en España, porque un relay quiere ancho de banda
estable y una línea residencial no lo da de forma fiable.
...
Valid llegan enseguida. Pero Stable exige una semana de uptime *continuo*, así
que un reinicio temprano para cambiar una línea de configuración reinicia el
contador. Si vas a trastear, trastea en la primera hora y luego déjalo en paz.

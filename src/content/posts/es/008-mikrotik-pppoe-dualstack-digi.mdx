...
<TLDRSummary title="Lo que vas a configurar">
  - **PPPoE sobre VLAN 20** con el formato de usuario `identificador@digi` para la autenticación en la fibra de DIGI España
  ...
  - **MTU negociado a 1480** vía LCP independientemente de `max-mtu=1500` — ese parámetro es solo el límite superior del cliente, no el MTU real del enlace

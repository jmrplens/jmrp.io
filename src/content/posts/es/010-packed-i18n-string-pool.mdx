...
<MemoryMap
  ...
  bars={[
    {
      label: "Ingenuo (tabla de punteros)",
      segments: [
...
<DeltaCompare
  ...
  caption="Ingenuo (antes) vs empaquetado (después) en -Os. El índice se reduce a la mitad con un −2.730 B (−50%) constante; los datos i18n bajan −3.012 B; todo el firmware encoge −2.224 B — todas las métricas a favor del diseño empaquetado."
/>

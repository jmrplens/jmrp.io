...
<FileContent filename="strings_gen.cpp (versión básica)" icon="devicon:cplusplus" language="cpp">
```cpp
// 5 languages × 273 ids
...
<FileContent filename="strings_gen.cpp (empaquetado)" icon="devicon:cplusplus" language="cpp">
```cpp
...
<FileContent filename="src/ui/… (puntos de llamada reales)" icon="devicon:cplusplus" language="cpp">
```cpp
using i18n::tr;
...
<FileContent filename="scripts/gen_i18n.py (el empaquetador)" icon="devicon:python" language="python">
```python
...
Esto salió de Kleidos, un gestor de contraseñas hardware que estoy construyendo — todavía no publicado. La capa i18n es un rincón pequeño de él, pero es un buen recordatorio de que en un objetivo limitado los ahorros interesantes a menudo no están en los datos que almacenas, sino en cómo los _indexas_.

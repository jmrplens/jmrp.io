...
<Table title="Puertos UDP para detección del honeypot">
  ...
  <tbody>
    ...
    <tr><td>11211</td><td>Memcached</td><td>Amplificación</td><td>**¡Amplificación 52.000x!** [Vector de DDoS récord](https://github.blog/news-insights/company-news/ddos-incident-report/)</td></tr>
...
<BarChart
  ...
  data={[
    { label: "Estados Unidos (US)", value: 484 },
    { label: "Países Bajos (NL)", value: 194 },
    { label: "China (CN)", value: 127 },
    { label: "Brasil (BR)", value: 81 },
    { label: "Rusia (RU)", value: 59 },
    { label: "Bulgaria (BG)", value: 58 },
    { label: "Alemania (DE)", value: 50 },

...
<Table title="Puertos TCP para detección del honeypot">
  ...
  <tbody>
    ...
    <tr><td>8291</td><td>Winbox</td><td>MikroTik</td><td>Toma de control del router mediante [CVEs conocidos](https://mikrotik.com/security)</td></tr>
...
<BarChart
  ...
  showPercentage={true}
  showValue={true}
  caption="Datos recopilados de todas las alertas en mi conexión doméstica"

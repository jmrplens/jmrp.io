...
<Mermaid caption="Honeypot Detection Flow" maxWidth="400px">
```mermaid-render
flowchart TD
    ...
    B -->|No: Port 80/443| C["Allow - Web Server"]:::success
    B -->|Yes: Port 22/3389/etc.| D["Honeypot Triggered"]:::warning
    
    D --> E["Log with prefix"]
    D --> F["Add IP to BlackList"]
    
    F --> G["RAW Table Rule"]
    G -->|All future packets| H["DROP instantly"]:::danger
```
</Mermaid>

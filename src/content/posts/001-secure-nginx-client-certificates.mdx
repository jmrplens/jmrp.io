...
server {
    ...
    location / {
        ...
        # WARNING: Clear/overwrite these headers from any upstream proxy
        # to prevent spoofing. Backend should only trust these when
        # requests originate directly from this Nginx instance.

...
The configuration above isn't a lab exercise — it's the WireGuard setup running today on my own RB5009UG+S+ on RouterOS 7.23.2, with `wg_devices` on UDP port 53537 exactly as used throughout this guide, serving 3 active peers at the standard 1500 MTU.

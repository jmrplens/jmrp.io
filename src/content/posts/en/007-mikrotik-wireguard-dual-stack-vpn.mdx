...
<TLDRSummary title="TL;DR — dual-stack WireGuard on RouterOS">
  ...
  - **Clamp TCP MSS to 1420 or large downloads stall.** MSS is MTU minus the 40-byte IPv6 header minus the 20-byte TCP header, and 1420 is the conservative value that holds on both stacks.

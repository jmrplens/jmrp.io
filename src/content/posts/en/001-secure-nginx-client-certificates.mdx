...
A CA is the root of trust in your PKI. The certificates it issues follow the [X.509 v3](https://www.rfc-editor.org/rfc/rfc5280) (RFC 5280) profile that underpins the public web PKI.
...
Only TLS 1.2 and TLS 1.3 belong in a modern configuration. [TLS 1.3](https://www.rfc-editor.org/rfc/rfc8446) (RFC 8446) is the current standard, with a faster handshake and AEAD-only cipher suites:

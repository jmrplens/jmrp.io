...
lead: "One bridge running obfs4 and WebTunnel at once, with Nginx making the WebTunnel half indistinguishable from ordinary HTTPS. Running and Valid arrive within the hour; Stable and Guard took about a week here, because they are scored on sustained reliability rather than a plain uptime counter."
...
howto:
  ...
  steps:
    - name: "Install Tor from the official repository"
      ...
      anchor: "step-1-install-tor-from-the-official-repository"
    - name: "Compile and install the WebTunnel server"
      ...
      anchor: "step-2-install-webtunnel-optional-but-recommended"
    - name: "Configure the Tor bridge in torrc"
      ...
      anchor: "step-3-configure-the-tor-bridge"
    - name: "Configure Nginx for WebTunnel camouflage"
      ...
      anchor: "step-4-configure-nginx-for-webtunnel-camouflage"
    - name: "Configure port forwarding and the firewall"
      ...
      anchor: "step-5-configure-port-forwarding"
    - name: "Allow obfs4proxy in AppArmor"
      ...
      anchor: "step-6-apparmor-configuration"
    - name: "Start the bridge and verify it works"
      ...
      anchor: "step-7-start-and-verify"
    - name: "Set up Prometheus and Grafana monitoring"
      ...
      anchor: "step-8-monitoring-with-prometheus-and-grafana"
    - name: "Integrate CrowdSec without blocking Tor clients"
      ...
      anchor: "step-9-crowdsec-integration-if-applicable"
---
...
In 2026, over **2.5 million people** use the [Tor network](https://www.torproject.org/) every single day to access the free and open internet — [Tor Metrics puts the daily estimate above three million for most of the year](https://metrics.torproject.org/userstats-relay-country.html). Journalists in authoritarian regimes, activists organizing protests, whistleblowers exposing corruption, and ordinary citizens protecting their privacy — all of them depend on a network that is entirely **volunteer-operated**.
...
<Timeline events={[
  ...
  { date: "2026", title: "Today", description: "~10,000 relays, ~2,600 bridges, and 2.5+ million daily users across 200+ countries. The network is entirely volunteer-operated.", type: "default" },
]} />
...
<TerminalCommand ariaLabel="Install prerequisite packages">
```bash
sudo apt update
...
<SecurityRating
  ...
  description="By running an obfs4 + WebTunnel bridge with proper monitoring, firewall hardening, and camouflage, you're providing one of the most valuable resources in the Tor ecosystem. The network has ~10,000 relays but only ~2,600 bridges — your bridge directly serves the most vulnerable users."
/>

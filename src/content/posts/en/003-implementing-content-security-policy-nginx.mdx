...
<Timeline events={[
  { date: "2010", type: "default", title: "X-Content-Security-Policy", description: "Mozilla introduces the first CSP implementation as an experimental header. [Mozilla Security Blog](https://blog.mozilla.org/security/2009/06/19/content-security-policy/)" },

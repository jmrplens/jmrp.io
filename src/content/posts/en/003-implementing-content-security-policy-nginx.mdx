...
<Table title="CSP Testing Tools">
  ...
  <tbody>
    <tr>
      <td><a href="https://developer.mozilla.org/en-US/observatory" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="Mozilla Observatory (opens in new tab)"><strong>Mozilla Observatory</strong></a></td>
      <td>Comprehensive security header grading (A+ possible)</td>
    </tr>
    <tr>
      <td><a href="https://csp-evaluator.withgoogle.com/" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="Google CSP Evaluator (opens in new tab)"><strong>Google CSP Evaluator</strong></a></td>
      <td>Finds logical bypasses in your policy (highly recommended)</td>
    </tr>
    <tr>
      <td><a href="https://securityheaders.com/" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="SecurityHeaders.com (opens in new tab)"><strong>SecurityHeaders.com</strong></a></td>
      <td>Quick header analysis and scoring</td>
    </tr>
    <tr>
      <td><a href="https://report-uri.com/tools/csp-hash-generator" target="_blank" rel="noopener noreferrer" class="external-link" aria-label="CSP Hash Generator (opens in new tab)"><strong>CSP Hash Generator</strong></a></td>

...
lead: "DIGI Spain hands the PPPoE session out on VLAN 20 and delegates a /56 by DHCPv6-PD — and the link MTU negotiates down to 1480 through LCP no matter what you set max-mtu to."
...
howto:
  ...
  steps:
    - name: "Configure the physical interface"
      ...
      anchor: "step-1-configure-the-physical-interface"
    - name: "Create the VLAN interface"
      ...
      anchor: "step-2-create-the-vlan-interface"
    - name: "Configure the PPPoE client"
      ...
      anchor: "step-3-configure-the-pppoe-client"
    - name: "Add interfaces to the WAN list"
      ...
      anchor: "step-4-add-interfaces-to-wan-list"
    - name: "Configure the DHCPv6 client for prefix delegation"
      ...
      anchor: "step-5-configure-dhcpv6-client-for-prefix-delegation"
    - name: "Configure Neighbor Discovery for SLAAC"
      ...
      anchor: "step-7-configure-neighbor-discovery-slaac"
    - name: "Configure IPv4 NAT (masquerade)"
      ...
      anchor: "step-8-configure-ipv4-nat-masquerade"
    - name: "Verify the connection"
      ...
      anchor: "step-9-verify-the-connection"
---
...
<TLDRSummary title="TL;DR — DIGI Spain dual-stack on RouterOS">
...
This isn't theoretical: my own RB5009UG+S+, running RouterOS 7.23.2, runs exactly this PPPoE + DHCPv6-PD setup against DIGI, with the WAN VLAN tagged `vlan-id=20` (`VLAN_DIGI`) just as described above.

...
<Callout type="warning" icon="mdi:alert-decagram">
  **`report-uri` is deprecated** in favor of `report-to` (Reporting API). For maximum browser compatibility, use **both directives** in your CSP.

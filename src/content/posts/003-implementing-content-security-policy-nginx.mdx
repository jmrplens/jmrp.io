...
<Prerequisite title="Before You Start">
  - A web server running **Nginx 1.25.1+** (for `$request_id` nonce support and `http2 on;` directive)
...
<Timeline events={[
  ...
  { date: "2016", title: "CSP Level 2", description: "Introduces nonces, hashes, and frame-ancestors. 'unsafe-inline' can be overridden by nonces", type: "milestone" },
  ...
  { date: "2023+", title: "CSP Level 3 (Working Draft)", description: "Introduces Trusted Types, report-to, and improved WebAssembly support", type: "milestone" },

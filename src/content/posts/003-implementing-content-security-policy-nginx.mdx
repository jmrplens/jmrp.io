...
<Mermaid caption="Trusted Types enforce sanitization at DOM sinks" maxWidth="650px">
```mermaid-render
flowchart LR
    subgraph Without["Without Trusted Types"]
        A1["User Input"] --> B1["innerHTML"]:::danger
        B1 --> C1["XSS Executed"]:::danger
    end
    
    subgraph With["With Trusted Types"]
        A2["User Input"] --> D2["Sanitizer Policy"]:::cspTrusted
        D2 --> E2["TrustedHTML Object"]:::cspTrusted
        E2 --> B2["innerHTML"]:::success
        B2 --> C2["Safe"]:::success
    end
```
</Mermaid>

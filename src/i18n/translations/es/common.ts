...
export const common = {
  ...
  pages: {
    ...
    homelab: {
      ...
      kpiActiveConnections: "conexiones activas",
      ...
      twinFleet: "Endpoints MCP que se pueden llamar",
      twinReplicas: "réplicas vivas",
      twinStatus: "Estado",
      twinCapturedAt: "Hora de captura",
      twinRefresh: "se refresca como mucho una vez por minuto",
      ...
      routerDrops: "Paquetes descartados · 24h",
      banIps: "IPs distintas · 24h",
      routerBlocklist: "En lista del router",

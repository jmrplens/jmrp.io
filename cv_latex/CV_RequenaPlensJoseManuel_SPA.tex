...
\cvevent{Ingeniero de software}{\href{https://power-electronics.com/}{Power Electronics}}{Abril 2023 -- actualmente}{Departamento de I+D. Ãrea de solar.}
\vspace{-1em}
\begin{justify}
...
\cvskill{C}{4}
\cvskill{STM32 \& ARM}{4}
\cvskill{Protocolos de com.}{4}
\cvskill{Keil uVision}{4}
\cvskill{Instrumentación}{4}

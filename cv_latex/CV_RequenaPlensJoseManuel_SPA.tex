...
\hypersetup{%
	...
	pdftitle={José Manuel Requena Plens - Ingeniero de Firmware Embebido y Software (CV)},
...
\end{justify}
\begin{itemize}
	\item Optimización del sistema de archivos embebido, reduciendo tiempos de acceso y mejorando la estabilidad en operación continua.
	\item Mejora del rendimiento en comunicaciones TCP, reduciendo latencia y aumentando la robustez del stack de red.
	\item Optimización de tareas en STM32: reducción de consumo de stack y heap, y ajuste de ciclos de CPU para mejorar el rendimiento en tiempo real.
	\item Implementación y mantenimiento de comunicaciones industriales: Modbus RTU/TCP, UART, I2C y SPI.
	\item Desarrollo en C con capas HAL y gestión de periféricos de bajo nivel.
	\item Automatización de pruebas hardware-in-the-loop (HIL) en Python (pytest): tests unitarios, de integración y de estrés integrados en pipelines de CI/CD.
\end{itemize}
\end{minipage}
\vspace{0.5em}

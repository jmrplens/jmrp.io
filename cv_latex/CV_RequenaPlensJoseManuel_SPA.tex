...
%% Flujo de metadatos XMP (lo leen los buscadores: Google, Bing, Scholar).
%% Se carga tras hyperref, que la clase incluye con la opción "withhyper".
\usepackage{hyperxmp}
...
\hypersetup{%
	...
	pdftitle={José Manuel Requena Plens - Ingeniero de Firmware y Software (CV)},
	pdfsubject={Currículum Vitae - Firmware embebido, ingeniería de software y QA / automatización de pruebas},
	pdfcreator={LaTeX (XeLaTeX) con altacv},
	pdflang={es},
	pdfkeywords={José Manuel Requena Plens, CV, Currículum Vitae, Ingeniero de Firmware, Ingeniero de Software, QA, Firmware, Sistemas Embebidos, STM32, ARM, C, C++, Python, RTOS, FreeRTOS, Automatización de pruebas, CI/CD, Valencia, España},
    }
...
\tagline{Ingeniero de Firmware y Software \newline C · C++ · Python · RTOS · Automatización de pruebas · CI/CD}
\photo{2.5cm}{foto}
\personalinfo{
...
%Â¿Algún texto sobre mí como carta de presentación aquí?
...
{\footnotesize\itshape Disponibilidad: presencial, remota o híbrida.}

\vspace{1.5em}
\cvsection{Experiencia}

\begin{minipage}{\linewidth}
\cvevent{Ingeniero de software}{\href{https://power-electronics.com/es}{Power Electronics S.L.}}{Abril 2023 -- Mayo 2026}{Departamento de I+D. Área de solar.}
\vspace{-1em}
\begin{justify}
...
\begin{itemize}
	...
	\item Rediseñé el acceso al sistema de archivos embebido, reduciendo los tiempos de acceso más de un 50\% e implementé un borrado programado (diario/mensual) que limpia de forma segura miles de archivos en operación continua.
	...
	\item Automaticé la suite de pruebas: $\sim$50--80 tests unitarios por módulo (Ceedling, miles en total) con 100\% de cobertura de líneas y ramas mediante \textit{mocks}/\textit{fakes} de la librería estándar, más cientos de pruebas de integración sobre hardware real (pytest); todo en CI.
	\item Revisé los \textit{merge requests} de un equipo de 12 personas, detectando bugs y proponiendo mejoras antes de la integración.
\end{itemize}
\end{minipage}
\vspace{0.5em}
...
\end{justify}
\begin{itemize}
	\item Desarrollé metadifusores acústicos que alcanzan un coeficiente de difusión de 0,8 con un espesor 10$\times$ menor que los difusores tradicionales.
	...
	\end{itemize}
	\item Diseñé e imprimí en 3D (resina) guías de ondas de tubo con rendijas calculadas numéricamente (tubos de 2--3 cm, rendijas $\sim$0,5 mm) que aumentaron $\sim$15$\times$ la directividad y el alcance ultrasónico en aire, validado experimentalmente.
...
\begin{itemize}
	\vspace{0.25em}
	\item Diseñé la geometría óptima del metamaterial acústico, logrando absorción casi total ($\alpha \approx 1$) en 200--500 Hz con un diseño sub-longitud de onda (ratio $\lambda$/espesor $\approx 16{,}5$ frente a $\sim$2 convencional), validado con prototipos reales.
	\item Simulación de un entorno real para validar el funcionamiento del diseño.
	\item Diseñé e imprimí en 3D el primer prototipo; para la versión a gran escala diseñé el modelo de fabricación por inyección y gestioné con un proveedor la producción de 600 módulos.
	\item Desarrollo de software para realizar medidas acústicas según normas ISO 10534-2 y ASTM E2611. \href{https://github.com/jmrplens/A-Lab}{\bf A|Lab}.
	\item Diseño y desarrollo de sistema robótico de 3 ejes para realizar las medidas experimentales. Fotografías y algo de información aquí: \href{https://cienciagandia.webs.upv.es/2022/03/metamaterial-para-reducir-el-ruido-en-el-lanzamiento-de-cohetes-espaciales/}{\bf Noticia}.
...
\begin{minipage}{\linewidth}
\cvevent{Fundador y Vocal}{\href{https://www.linkedin.com/company/a-\%C2\%B5tech/}{AµTech}}{Septiembre 2016 -- Julio 2018}{\href{https://www.ua.es/}{Universidad de Alicante}}
\vspace{-0.5em}
\begin{justify}
...
%% Profdent (técnico de laboratorio dental) oculto — baja relevancia para los
%% roles objetivo actuales. Descomentar el bloque para restaurarlo.
%\divider
%
%\begin{minipage}{\linewidth}
...
\cvskill{\faProjectDiagram~Protocolos de com.}{4}
\cvskill{\faBug~Depuración HW}{4}
\cvskill{\faMicrochip~Keil uVision}{4}
\cvskill{\faLock~Secure Boot y Seg. Embebida}{3}
\cvskill{\simpleicon{doxygen}~Doxygen}{4}
\cvskill{\faTools~Instrumentación}{4}

\vspace{1em}

\cvskillheader{Calidad, CI/CD y DevSecOps}
...
\cvskill{\faSearch~Análisis estático y SAST}{3}
...
\cvskillheader{Seguridad y Criptografía}
\cvskill{\faKey~Criptografía aplicada}{3}
\cvskill{\faCertificate~TLS / mTLS / PKI}{4}
\cvskill{\simpleicon{nginx}~Hardening de Nginx}{4}
\cvskill{\simpleicon{crowdsec}~CrowdSec}{3}
\cvskill{\faUserShield~Hardening de red}{4}

\vspace{1em}

\cvskillheader{IA e Ingeniería de Agentes}
\cvskill{\simpleicon{modelcontextprotocol}~Model Context Protocol (MCP)}{4}
\cvskill{\faRobot~Agentes de IA y buenas prácticas}{4}
\cvskill{\faBrain~Integración de LLMs}{3}
...
\cvskill{\faWaveSquare~Instrumentación acústica}{4}
...
\begin{minipage}{\linewidth}
\cvevent{\href{http://www.upv.es/entidades/EDOCTORADO/info/1005218normalc.html}{Doctorado en Tecnologías para la Salud y el Bienestar}}{\small \href{http://www.upv.es/es}{Universidad Politécnica de Valencia}}{Septiembre 2020 -- 2023 (no finalizado)}{\href{https://www.i3m-stim.i3m.upv.es/}{Instituto de Instrumentación para Imagen Molecular i3M}}
...
\noindent Trabajo Final de Grado titulado \href{https://rua.ua.es/entities/publication/51f4a3fd-7a4b-4d5a-9ff1-3cd7900b7d0f}{``Estudio de la relación campo directo/reverberado; útil/perjudicial"}.
\vspace{0.5em}
...
\begin{minipage}[t]{0.49\textwidth}
    ...
    \begin{tabular*}{\linewidth}{@{} l @{\extracolsep{\fill}} r @{}}
    	...
    	\href{http://www.upv.es/pls/oalu/sic_gdoc.get_content?P_ASI=40016&P_IDIOMA=c&P_VISTA=&P_TIT=0&P_CACA=2022}{Persp. de género (investig.)} & \href{http://www.upv.es/es}{UPV}. {\bf 50} H.\\
    \end{tabular*}
    ...
    \begin{tabular*}{\linewidth}{@{} l @{\extracolsep{\fill}} r @{}}
    	...
    	\href{http://www.upv.es/pls/oalu/sic_gdoc.get_content?P_ASI=40010&P_IDIOMA=c&P_VISTA=&P_TIT=0&P_CACA=2022}{Métodos numéricos (MATLAB)} & \href{http://www.upv.es/es}{UPV}. {\bf 50} H.\\
    	\href{http://www.upv.es/pls/oalu/sic_gdoc.get_content?P_ASI=40012&P_IDIOMA=c&P_VISTA=&P_TIT=0&P_CACA=2022}{Computación científica} & \href{http://www.upv.es/es}{UPV}. {\bf 50} H.\\
    	\href{http://www.upv.es/pls/oalu/sic_gdoc.get_content?P_ASI=40011&P_IDIOMA=c&P_VISTA=&P_TIT=0&P_CACA=2022}{Documentos con LaTeX} & \href{http://www.upv.es/es}{UPV}. {\bf 56} H.\\
    \end{tabular*}
\end{minipage}
\vspace{0.5em}
\par\vspace{1em}

%% "Cursos y seminarios" integrados en las tablas de certificados de arriba
%% (Tecnologías de la información y Competencias transversales). Subsección
%% original conservada en comentario por si se quiere recuperar.
...
% Sección de publicaciones desactivada — descomentar para volver a mostrarla
%\vspace{1.5em}
